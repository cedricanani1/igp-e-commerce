                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-20">
                                        ...
                                        <input v-model="order.raison_social" placeholder="" type="text" required>     
                                    </div>
                                    <div class="col-12 mb-20">
                                        <label>Ville  <span class="text-danger">*</span></label>
                                        <input v-model="order.ville" placeholder="" type="text" required>     
                                    </div>
                                    <div class="col-12 mb-20">
                                        <label>Commune </label>
                                        <input v-model="order.commune" type="text">    
                                    </div> 
                                    <div class="col-lg-6 mb-20">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-12 mb-20">
                                                    <div class="select_form_select">
                                                        <label for="countru_name">country <span class="text-danger">*</span></label>
...
export default {
  ...
  methods:{
    ...
    orderSubmit(){
        if (this.order.email_verified_at) {
